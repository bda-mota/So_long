...
/*   Updated: 2024/02/19 13:02:09 by bda-mota         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_game
{
	...
	t_sprites		*playerl_data;
	t_sprites		*player_m1_data;
	t_sprites		*player_m2_data;
	...
	t_sprites		*tnt_data;
	t_sprites		*exit_data;
	t_sprites		*ironwall_data;
	mlx_image_t		*txt_steps;
	mlx_image_t		*count_steps;
}	t_game;
